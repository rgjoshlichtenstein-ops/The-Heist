...
// ── BURN ENDING ────────────────────────────────────────
// Shown when the ace is spent and the next scene is still fully locked.
// Each crew member signs off in order, in their voice, then silence.

burnOut: [
  {
    who: 'VALE',
    line: "I'm pulling the feed. The numbers stopped making sense two scenes ago. I told myself it was recoverable. It wasn't. I'm sorry.",
  },
  {
    who: 'NIX',
    line: "I held position longer than I should have. That's on me. Don't try to reach me on this channel after tonight.",
  },
  {
    who: 'ROOK',
